...
def WebEdgeCapture():
    ...
    cv2.createTrackbar('threshold1', "FaceDetected", 0, 255, nothing) #트랙바 생성하기1

    cv2.createTrackbar('threshold2', "FaceDetected", 0, 255, nothing)  # 트랙바 생성하기2
    cv2.setTrackbarPos('threshold1', "FaceDetected", 127)  # 트랙바 초기값1
    cv2.setTrackbarPos('threshold2', "FaceDetected", 127)  # 트랙바 초기값2
    ...
    while True:
        ...
        threshold1 = cv2.getTrackbarPos('threshold1', "FaceDetected")
        threshold2 = cv2.getTrackbarPos('threshold2', "FaceDetected")
